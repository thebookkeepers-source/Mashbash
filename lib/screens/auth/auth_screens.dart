                      ...
                      child: Column(
                        children: [
                          ...
                          AsyncButton(
                            ...
                            onPressed: () {
                              if (_form.currentState!.validate()) context.read<AppProvider>().login(_phone.text, _password.text);
                            },
                          ),
                          TextButton(
                  ...
                  AsyncButton(
                    ...
                    onPressed: () {
                      if (_form.currentState!.validate()) {
                        context.read<AppProvider>().register(name: _name.text, phone: _phone.text, address: _address.text, password: _password.text);
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void initState() {
    super.initState();
    _name = TextEditingController(text: context.read<AppProvider>().auth.currentUser?.displayName ?? '');
  }
